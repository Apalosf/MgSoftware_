...
namespace Infra.Common
{
    public struct Positions
    {
        ...
        public const string Receptionist = "RECEPCIONIST";
        ...
        public const string AlmacenistAssistant = "ALMACENIST ASSISTANT";
        ...
        {//Método para listar los cargos. Se usa para establece la fuente de datos
            ...
            positions.Add(ProductionManager);
            positions.Add(ProductionSupervisor);
            positions.Add(AlmacenistAssistant);
            positions.Sort();
            return positions;
        }
    }
