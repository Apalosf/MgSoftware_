...
namespace Domain.Models
{
    public class UserModel : IUserModel
    {
        ...
        {//Mapear un solo objeto.
            ...
            {
                Id = userEntity.Users_Id,
                Username = userEntity.Users_UserName,
                Password = userEntity.Users_Password,
                FirstName = userEntity.Users_FirsName,
                LastName = userEntity.Users_LastName,
                Position = userEntity.Users_Position,
                Email = userEntity.Users_Email,
                Photo = userEntity.Users_Photo
            };
            return userModel;
        }
        ...
        {//Mapear un solo objeto.
            ...
            {
                Users_Id = userModel.Id,
                Users_UserName = userModel.Username,
                Users_Password = userModel.Password,
                Users_FirsName = userModel.FirstName,
                Users_LastName = userModel.LastName,
                Users_Position = userModel.Position,
                Users_Email = userModel.Email,
                Users_Photo = userModel.Photo
            };
            return userEntity;
        }        
