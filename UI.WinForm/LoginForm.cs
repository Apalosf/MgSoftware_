...
namespace UI.WinForm
{
    public partial class LoginForm : Form
    {
        ...
        {//Iniciar sesión
            ...
            {
                ShowMessage("INGRESE NOMBRE DE USUARIO O CORREO ELECTRONICO");
                return;
            }
            ...
            {                
                ...
                {
                    mainForm = null;
                    MessageBox.Show("USTED NO CUENTA CON UNA ASIGANACION DE CARGO EN LA EMPRESA, NO PUEDE INICIAR SESION.","MENSAJE DEL ADMINISTRADOR DE BD",
